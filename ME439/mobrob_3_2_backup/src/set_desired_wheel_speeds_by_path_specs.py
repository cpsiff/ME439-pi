...
import me439_mobile_robot_class_v01 as m439rbt # added by me
...
stage_settings = np.array([
    robot.plan_pause(1.0),
    robot.plan_arc(1, 1, np.pi),
    robot.plan_line(1, 0.3),
    robot.plan_arc(0.5, 1, np.pi),
    robot.plan_arc(-0.5, 1, np.pi),
    robot.plan_line(1, 0.5)
])
