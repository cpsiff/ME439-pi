...
# =============================================================================
    def plan_arc(self, radius, speed, angle):
        ...
        lft_whl_spd = 1-(self.wheel_width/(2*radius))*speed
        rgt_whl_spd = 1+(self.wheel_width/(2*radius))*speed
        ...
        # COMPUTE the duration (time in seconds) for which they should turn at these speeds.
        duration = omega/speed
        
        return [duration, lft_whl_spd, rgt_whl_spd]

        # my code from set_desired_wheel_speeds_v01.py
...
# =============================================================================
    def plan_pivot(self, omega, angle):
        ...
        rgt_whl_spd = self.wheel_width*omega/2
        lft_whl_spd = -rgt_whl_spd
        
        # COMPUTE the duration (time in seconds) for which they should turn at these speeds.
        duration = 1 # not sure about this...
